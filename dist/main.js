...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_TodoList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/TodoList.js */ \"./src/modules/TodoList.js\");\n/* harmony import */ var _modules_Todo_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Todo.js */ \"./src/modules/Todo.js\");\n\n\n\nvar formSubmit = document.querySelector('#form');\nvar clear = document.querySelector('#remove');\nvar todoElement = document.querySelector('.todo-container');\nvar todoList = new _modules_TodoList_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n\nvar renderTodos = function renderTodos() {\n  todoElement.innerHTML = '';\n\n  if (todoList.getAllTodos().length === 0) {\n    todoElement.innerHTML = '<p class= \"empty\"> No todos yet</p>';\n  } else {\n    todoList.getAllTodos().forEach(function (todo, index) {\n      var todoItem = document.createElement('div');\n      todoItem.classList.add('todo-item');\n\n      var checkTodoStatus = function checkTodoStatus() {\n        var status = '';\n\n        if (todo.completed) {\n          status = 'checked';\n        } else {\n          status = '';\n        }\n\n        return status;\n      };\n\n      todoItem.innerHTML = \"\\n      <div data-check = \".concat(index, \" class=\\\"todo border-bottom flex\\\">\\n        <input data-complete = \").concat(todo.id, \" class=\\\"box\\\" \").concat(checkTodoStatus(), \" type=\\\"checkbox\\\" />\\n        <input data-item = \").concat(todo.id, \" class=\\\"item \").concat(checkTodoStatus(), \"\\\" type=\\\"text\\\" value=\\\"\").concat(todo.description, \"\\\" />\\n        <i id=\\\"delete-btn\\\" data-remote = \").concat(index, \" class='bx bx-trash' id=\\\"delete-btn\\\"></i>\\n      </div>\\n    \");\n      todoElement.appendChild(todoItem);\n    });\n  }\n\n  var todoItems = document.querySelectorAll('.item');\n  var checkboxes = document.querySelectorAll('.box');\n  checkboxes.forEach(function (checkbox) {\n    checkbox.addEventListener('click', function (e) {\n      if (checkbox.checked) {\n        todoList.changeCompleted(e.target.dataset.complete);\n        todoItems[e.target.dataset.complete - 1].classList.add('checked');\n      } else {\n        todoList.changeCompleted(e.target.dataset.complete);\n        todoItems[e.target.dataset.complete - 1].classList.remove('checked');\n      }\n    });\n  });\n  var deletBtn = document.querySelectorAll('#delete-btn');\n  deletBtn.forEach(function (btn) {\n    btn.addEventListener('click', function (e) {\n      var id = e.target.dataset.remote;\n      todoList.deleteTodo(id);\n      renderTodos();\n    });\n  });\n  var editTodo = document.querySelectorAll('.item');\n  var checkedBox = document.querySelectorAll('.box');\n  editTodo.forEach(function (todo) {\n    todo.addEventListener('keyup', function (e) {\n      var id = e.target.dataset.item;\n      var description = e.target.value.trim();\n      var completed = false;\n      var newTodo = new _modules_Todo_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](description, completed, id);\n      todoList.updateTodo(id, newTodo);\n      checkedBox[id - 1].checked = false;\n      todo.classList.remove('checked');\n    });\n  });\n\n  var clearAllTodos = function clearAllTodos() {\n    todoList.clearAllTodos();\n    renderTodos();\n  };\n\n  clear.addEventListener('click', clearAllTodos);\n};\n\nformSubmit.addEventListener('submit', function (e) {\n  e.preventDefault();\n  var todoDescription = document.querySelector('.input').value;\n  var todo = new _modules_Todo_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](todoDescription, false, todoList.getAllTodos().length + 1);\n  todoList.addTodo(todo);\n  formSubmit.reset();\n  document.querySelector('.input').focus();\n  renderTodos();\n});\nwindow.onload = renderTodos();\n\n//# sourceURL=webpack://my-to-do-list/./src/index.js?");
